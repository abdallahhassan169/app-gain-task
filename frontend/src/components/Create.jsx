  ...
  function handleChange(event) {
    ...
    const headers = {
          'Content-Type': 'multipart/form-data',
            ...
            axios.post("http://127.0.0.1:5000/create/",{"slug":slug,"web":web,"and_primary":and_primary,"and_fallback":and_fallback,"ios_primary":ios_primary,"ios_fallback":ios_fallback }, {"headers":headers})
            .then((output) => {
              console.log(output);
            })
            .catch((err) => {
    ...
    return (
        ...
        <div>
          <form >
            <label >Slug</label>
            <input type="text" onChange={e => setSlug(e.target.value)}   placeholder="Link slug.."></input>
            ...
            <button onClick={handleSubmit} type="submit"  value="Submit">Create </button>
          </form>
        </div>
        </>
    );
